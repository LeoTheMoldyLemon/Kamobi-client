...
namespace Kamobi.Views
{
    ...
    public partial class ChangePasswordSMSPage : ContentPage
    {
        public ChangePasswordSMSPage()
        {
            InitializeComponent();
        ...
        private async void ConfirmButtonClicked(object sender, EventArgs e)
        {
            ...
            Navigation.ShowPopup(new InfoPopup("Your password has been successfully changed!"));
